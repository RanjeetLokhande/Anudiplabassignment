...
public class StudentFilter 
{
	...
	public static void main(String[] args)
	{
		...
		stud.add(new Student(1,"Ranjeet",22,75));
		stud.add(new Student(2,"Ramesh",22,79));
		stud.add(new Student(3,"Pratik",24,80));
		stud.add(new Student(4,"Hardik",21,86));
		stud.add(new Student(5,"Amol",22,58));
		stud.add(new Student(6,"Ankit",22,60));
