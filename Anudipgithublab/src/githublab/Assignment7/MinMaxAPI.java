...
public class MinMaxAPI 
{
	...
	public static void main(String[] args) 
	{
		...
		stud.add(new StudentInfo (1,"Ranjeet",22,75));
		stud.add(new StudentInfo (2,"Ramesh",22,79));
		stud.add(new StudentInfo (3,"Kartik",24,80));
		stud.add(new StudentInfo (4,"Amar",21,86));
		stud.add(new StudentInfo (5,"Hardik",22,58));
		stud.add(new StudentInfo (6,"Amol",22,60));
